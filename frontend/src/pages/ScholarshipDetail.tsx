            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {scholarship.requirements?.documents && scholarship.requirements.documents.length > 0 && (
                <Card>
                  ...
                  <CardContent>
                    <ul className="space-y-3">
                      {scholarship.requirements.documents.map((item: string, index: number) => (
                        <li key={index} className="flex items-start gap-3">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      ...
                      "Applications are reviewed by the sponsor",
                      "Winners notified via the platform"
                    ].map((step, index) => (
            ...
            <div className="space-y-6">
              ...
              <Card className="card-elevated sticky top-24">
                <CardContent className="pt-6">
                  ...
                  {user ? (
                    <Button size="lg" className="w-full mb-3" asChild disabled={daysUntilDeadline() <= 0}>
