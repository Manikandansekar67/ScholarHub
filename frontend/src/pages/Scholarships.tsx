...
const amountRanges = [
  ...
  { label: "Over $15,000", value: "over-15000" },
];
...
const Scholarships = () => {
  ...
  const allScholarships: Scholarship[] = scholarshipsResponse?.data || [];

  const filteredScholarships = allScholarships.filter((scholarship) => {
    // Search filter
    const matchesSearch =
      scholarship.title.toLowerCase().includes(searchQuery.toLowerCase()) ||
      (scholarship.sponsor.organization || scholarship.sponsor.fullName).toLowerCase().includes(searchQuery.toLowerCase()) ||
    ...
    if (amountRange === "under-5000") matchesAmount = scholarship.amount < 5000;
    else if (amountRange === "5000-10000")
      matchesAmount = scholarship.amount >= 5000 && scholarship.amount <= 10000;
    else if (amountRange === "10000-15000")
      matchesAmount = scholarship.amount > 10000 && scholarship.amount <= 15000;
    else if (amountRange === "over-15000") matchesAmount = scholarship.amount > 15000;
  ...
  const hasActiveFilters =
    searchQuery || selectedCategory !== "All" || amountRange !== "any" || statusFilter !== "all";
