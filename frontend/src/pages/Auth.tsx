          ...
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {mode === "login"
                ...
                : "Join thousands of students finding scholarships"}
            </CardDescription>
          </CardHeader>
                      ...
                      {roleOptions.map((option) => (
                        <div key={option.value}>
                          ...
                          <Label
                            ...
                            className="flex flex-col items-center justify-center p-3 rounded-lg border-2 border-muted bg-popover cursor-pointer transition-all hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary peer-data-[state=checked]:bg-primary/5"
                          >
