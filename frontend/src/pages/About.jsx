            ...
            <section className="py-20">
                <div className="container">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="bg-muted rounded-2xl p-8 h-80 flex flex-col items-center justify-center gap-4">
                            <div className="flex h-24 w-24 items-center justify-center rounded-2xl hero-gradient shadow-lg">
                                <GraduationCap className="h-12 w-12 text-primary-foreground" />
                            </div>
                            <span className="text-2xl font-bold text-foreground mt-2">ScholarHub</span>
                        </div>
                    </div>
                </div>
            </section>
