...
import { FileText, Upload, Trash2, Download, Loader2, AlertCircle, File } from "lucide-react";
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="flex items-center justify-center w-full">
                                <Label htmlFor="dropzone-file" className={`flex flex-col items-center justify-center w-full h-64 border-2 border-dashed rounded-lg cursor-pointer bg-muted/5 hover:bg-muted/10 transition-colors ${isUploading ? 'opacity-50 pointer-events-none' : 'border-border'}`}>
                                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                        {isUploading ? <Loader2 className="w-10 h-10 mb-3 text-primary animate-spin" /> : <Upload className="w-10 h-10 mb-3 text-muted-foreground" />}
